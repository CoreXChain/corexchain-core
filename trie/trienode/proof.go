...
func (db *ProofSet) Store(target corexdb.KeyValueWriter) {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
// ProofList stores an ordered list of trie nodes. It implements corexdb.KeyValueWriter.
type ProofList []rlp.RawValue

// Store writes the contents of the list to the given database
func (n ProofList) Store(db corexdb.KeyValueWriter) {
	for _, node := range n {
