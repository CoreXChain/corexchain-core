...
func New(file string, cache int, handles int, namespace string, readonly bool, ephemeral bool) (*Database, error) {
	...
	// Disable seek compaction explicitly. Check https://corex.internal/corex-chain-repo/pull/20130
	// for more details.
...
func (d *Database) NewBatch() corexdb.Batch {
	return &batch{
		b:  d.db.NewBatch(),
		db: d,
	}
...
func (d *Database) NewBatchWithSize(size int) corexdb.Batch {
	return &batch{
...
func (d *Database) NewSnapshot() (corexdb.Snapshot, error) {
...
func (b *batch) Replay(w corexdb.KeyValueWriter) error {
	reader := b.b.Reader()
	for {
...
func (d *Database) NewIterator(prefix []byte, start []byte) corexdb.Iterator {
