...
// implementation.
func TestDatabaseSuite(t *testing.T, New func() corexdb.KeyValueStore) {
...
// implementation.
func BenchDatabaseSuite(b *testing.B, New func() corexdb.KeyValueStore) {
	var (
...
func iterateKeys(it corexdb.Iterator) []string {
	keys := []string{}
	for it.Next() {
