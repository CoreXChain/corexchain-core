...
// that address/topic, and binary AND-ing those vectors tocorexer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them tocorexer
				var orVector []byte
...
// the requested retrieval queue to be serviced tocorexer with other sessions.
//
