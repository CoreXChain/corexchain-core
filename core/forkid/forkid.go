...
// Package forkid implements EIP-2124 (https://eips.corexchain.org/EIPS/eip-2124).
package forkid
...
// timestampThreshold is the CoreXChain corenet genesis timestamp. It is used to
...
// NewID calculates the CoreXChain fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the CoreXChain fork ID from an existing chain instance.
