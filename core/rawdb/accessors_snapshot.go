...
func ReadSnapshotDisabled(db corexdb.KeyValueReader) bool {
	disabled, _ := db.Has(snapshotDisabledKey)
	return disabled
}

// WriteSnapshotDisabled stores the snapshot pause flag.
func WriteSnapshotDisabled(db corexdb.KeyValueWriter) {
...
func DeleteSnapshotDisabled(db corexdb.KeyValueWriter) {
...
func ReadSnapshotRoot(db corexdb.KeyValueReader) common.Hash {
...
// the persisted snapshot.
func WriteSnapshotRoot(db corexdb.KeyValueWriter, root common.Hash) {
...
// invalid.
func DeleteSnapshotRoot(db corexdb.KeyValueWriter) {
...
func ReadAccountSnapshot(db corexdb.KeyValueReader, hash common.Hash) []byte {
	data, _ := db.Get(accountSnapshotKey(hash))
	return data
}

// WriteAccountSnapshot stores the snapshot entry of an account trie leaf.
func WriteAccountSnapshot(db corexdb.KeyValueWriter, hash common.Hash, entry []byte) {
...
func DeleteAccountSnapshot(db corexdb.KeyValueWriter, hash common.Hash) {
...
func ReadStorageSnapshot(db corexdb.KeyValueReader, accountHash, storageHash common.Hash) []byte {
	data, _ := db.Get(storageSnapshotKey(accountHash, storageHash))
	return data
}

// WriteStorageSnapshot stores the snapshot entry of an storage trie leaf.
func WriteStorageSnapshot(db corexdb.KeyValueWriter, accountHash, storageHash common.Hash, entry []byte) {
...
func DeleteStorageSnapshot(db corexdb.KeyValueWriter, accountHash, storageHash common.Hash) {
...
func IterateStorageSnapshots(db corexdb.Iteratee, accountHash common.Hash) corexdb.Iterator {
...
func ReadSnapshotJournal(db corexdb.KeyValueReader) []byte {
...
func WriteSnapshotJournal(db corexdb.KeyValueWriter, journal []byte) {
...
// the last shutdown
func DeleteSnapshotJournal(db corexdb.KeyValueWriter) {
...
// the last shutdown.
func ReadSnapshotGenerator(db corexdb.KeyValueReader) []byte {
...
// shutdown.
func WriteSnapshotGenerator(db corexdb.KeyValueWriter, generator []byte) {
...
// the last shutdown
func DeleteSnapshotGenerator(db corexdb.KeyValueWriter) {
...
// snapshot layer.
func ReadSnapshotRecoveryNumber(db corexdb.KeyValueReader) *uint64 {
...
// snapshot layer.
func WriteSnapshotRecoveryNumber(db corexdb.KeyValueWriter, number uint64) {
	var buf [8]byte
...
// snapshot layer.
func DeleteSnapshotRecoveryNumber(db corexdb.KeyValueWriter) {
...
func ReadSnapshotSyncStatus(db corexdb.KeyValueReader) []byte {
	data, _ := db.Get(snapshotSyncStatusKey)
	return data
}

// WriteSnapshotSyncStatus stores the serialized sync status to save at shutdown.
func WriteSnapshotSyncStatus(db corexdb.KeyValueWriter, status []byte) {
