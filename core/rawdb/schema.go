...
var (
	...
	configPrefix   = []byte("corexchain-config-")  // config prefix for the db
	genesisPrefix  = []byte("corexchain-genesis-") // genesis state prefix for the db
...
// DirectTxLookupEntry is the historical TxLookupEntry definition with some unnecessary
// fields.
type DirectTxLookupEntry struct {
