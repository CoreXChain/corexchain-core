...
func inspect(name string, order map[string]bool, reader corexdb.AncientReader) (freezerInfo, error) {
...
func inspectFreezers(db corexdb.Database) ([]freezerInfo, error) {
