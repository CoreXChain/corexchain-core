...
func ReadAccountTrieNode(db corexdb.KeyValueReader, path []byte) ([]byte, common.Hash) {
...
func HasAccountTrieNode(db corexdb.KeyValueReader, path []byte, hash common.Hash) bool {
	data, err := db.Get(accountTrieNodeKey(path))
	if err != nil {
		return false
	}
...
func ExistsAccountTrieNode(db corexdb.KeyValueReader, path []byte) bool {
...
func WriteAccountTrieNode(db corexdb.KeyValueWriter, path []byte, node []byte) {
...
func DeleteAccountTrieNode(db corexdb.KeyValueWriter, path []byte) {
...
// hash with the specified node path.
func ReadStorageTrieNode(db corexdb.KeyValueReader, accountHash common.Hash, path []byte) ([]byte, common.Hash) {
...
// node path and the associated node hash.
func HasStorageTrieNode(db corexdb.KeyValueReader, accountHash common.Hash, path []byte, hash common.Hash) bool {
	data, err := db.Get(storageTrieNodeKey(accountHash, path))
	if err != nil {
		return false
	}
...
func ExistsStorageTrieNode(db corexdb.KeyValueReader, accountHash common.Hash, path []byte) bool {
...
func WriteStorageTrieNode(db corexdb.KeyValueWriter, accountHash common.Hash, path []byte, node []byte) {
...
func DeleteStorageTrieNode(db corexdb.KeyValueWriter, accountHash common.Hash, path []byte) {
...
func ReadLegacyTrieNode(db corexdb.KeyValueReader, hash common.Hash) []byte {
...
func HasLegacyTrieNode(db corexdb.KeyValueReader, hash common.Hash) bool {
	ok, _ := db.Has(hash.Bytes())
	return ok
}

// WriteLegacyTrieNode writes the provided legacy trie node to database.
func WriteLegacyTrieNode(db corexdb.KeyValueWriter, hash common.Hash, node []byte) {
...
func DeleteLegacyTrieNode(db corexdb.KeyValueWriter, hash common.Hash) {
...
func HasTrieNode(db corexdb.KeyValueReader, owner common.Hash, path []byte, hash common.Hash, scheme string) bool {
	switch scheme {
	case HashScheme:
...
//   - owner
//   - path
func ReadTrieNode(db corexdb.KeyValueReader, owner common.Hash, path []byte, hash common.Hash, scheme string) []byte {
	switch scheme {
	case HashScheme:
...
//   - owner
//   - path
func WriteTrieNode(db corexdb.KeyValueWriter, owner common.Hash, path []byte, hash common.Hash, node []byte, scheme string) {
	switch scheme {
	case HashScheme:
...
//   - owner
//   - path
func DeleteTrieNode(db corexdb.KeyValueWriter, owner common.Hash, path []byte, hash common.Hash, scheme string) {
	switch scheme {
	case HashScheme:
...
func ReadStateScheme(db corexdb.Reader) string {
...
//     compatible with persistent state scheme.
func ParseStateScheme(provided string, disk corexdb.Database) (string, error) {
