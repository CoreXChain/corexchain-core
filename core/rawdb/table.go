...
func NewTable(db corexdb.Database, prefix string) corexdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(corexdb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader corexdb.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) corexdb.Iterator {
...
func (t *table) NewBatch() corexdb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) corexdb.Batch {
...
func (t *table) NewSnapshot() (corexdb.Snapshot, error) {
...
func (b *tableBatch) Replay(w corexdb.KeyValueWriter) error {
