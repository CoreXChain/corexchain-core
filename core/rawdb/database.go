...
import (
	...
	"com.corexkey/corexdb/leveldb"
	"com.corexkey/corexdb/memorydb"
	"com.corexkey/corexdb/pebble"
	"com.corexkey/log"
...
type freezerdb struct {
	ancientRoot string
	corexdb.KeyValueStore
	corexdb.AncientStore
}
...
func (db *nofreezedb) ModifyAncients(func(corexdb.AncientWriteOp) error) (int64, error) {
	return 0, errNotSupported
}
...
func (db *nofreezedb) ReadAncients(fn func(reader corexdb.AncientReaderOp) error) (err error) {
...
func NewDatabase(db corexdb.KeyValueStore) corexdb.Database {
...
func NewDatabaseWithFreezer(db corexdb.KeyValueStore, ancient string, namespace string, readonly bool) (corexdb.Database, error) {
...
func NewMemoryDatabase() corexdb.Database {
...
func NewMemoryDatabaseWithCap(size int) corexdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (corexdb.Database, error) {
...
// moving immutable chain segments into cold storage.
func NewPebbleDBDatabase(file string, cache int, handles int, namespace string, readonly, ephemeral bool) (corexdb.Database, error) {
...
func openKeyValueDatabase(o OpenOptions) (corexdb.Database, error) {
...
func Open(o OpenOptions) (corexdb.Database, error) {
...
func InspectDatabase(db corexdb.Database, keyPrefix, keyStart []byte) error {
...
func printChainMetadata(db corexdb.KeyValueStore) {
...
func ReadChainMetadata(db corexdb.KeyValueStore) [][]string {
