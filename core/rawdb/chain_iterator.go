...
func InitDatabaseFromFreezer(db corexdb.Database) {
...
func iterateTransactions(db corexdb.Database, from uint64, to uint64, reverse bool, interrupt chan struct{}) chan *blockTxHashes {
...
// signal received.
func indexTransactions(db corexdb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool, report bool) {
...
// There is a passed channel, the whole procedure will be interrupted if any
// signal received.
func IndexTransactions(db corexdb.Database, from uint64, to uint64, interrupt chan struct{}, report bool) {
...
func indexTransactionsForTesting(db corexdb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool) {
...
// There is a passed channel, the whole procedure will be interrupted if any
// signal received.
func unindexTransactions(db corexdb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool, report bool) {
	// short circuit for invalid range
	if from >= to {
		return
	}
...
// There is a passed channel, the whole procedure will be interrupted if any
// signal received.
func UnindexTransactions(db corexdb.Database, from uint64, to uint64, interrupt chan struct{}, report bool) {
...
func unindexTransactionsForTesting(db corexdb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool) {
