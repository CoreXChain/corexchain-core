...
// stateObject represents a CoreXChain account which is being modified.
//
...
type stateObject struct {
	db       *StateDB
	address  common.Address      // address of corexchain account
	addrHash common.Hash         // hash of corexchain address of the account
