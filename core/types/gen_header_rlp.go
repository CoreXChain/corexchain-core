...
func (obj *Header) EncodeRLP(_w io.Writer) error {
	...
	_tmp3 := obj.BundleResourceUsed != nil
	_tmp4 := obj.ExcessBundleResource != nil
	...
	if _tmp3 || _tmp4 || _tmp5 {
		if obj.BundleResourceUsed == nil {
			w.Write([]byte{0x80})
		} else {
			w.WriteUint64((*obj.BundleResourceUsed))
		}
	}
	if _tmp4 || _tmp5 {
		if obj.ExcessBundleResource == nil {
			w.Write([]byte{0x80})
		} else {
			w.WriteUint64((*obj.ExcessBundleResource))
		}
	}
	if _tmp5 {
