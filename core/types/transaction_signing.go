...
// this enables support for chain-protected replay protection and all implemented typed envelope
...
// - adaptive fee adaptive fee transactions
// - access-profile access list transactions,
// - chain-protected replay protected transactions, and
...
func (s londonSigner) SignatureValues(tx *Transaction, sig []byte) (R, S, V *big.Int, err error) {
	txdata, ok := tx.inner.(*AdaptiveFeeTx)
	if !ok {
...
// NewEIP2930Signer returns a signer that accepts access-profile access list transactions,
// chain-protected replay protected transactions, and legacy Homestead transactions.
...
// EIP155Signer implements Signer using the chain-protected rules. This accepts transactions which
