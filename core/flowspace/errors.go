...
var (
	...
	// ErrUnderpriced is returned if a transaction's value-flow fee is below the minimum
	// configured for the flow space.
	...
	// input transaction of another type when a bundle transaction from this sender
