...
// described in the BundlePool docs for both fee components.
//
...
// described in the BundlePool docs for a single fee component.
...
func intLog2(n uint) int {
	...
	default:
		...
		panic("adaptive fee jump diffs cannot reach this")
	}
}
