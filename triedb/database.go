...
type Database struct {
	...
	diskdb    corexdb.Database // Persistent database to store the snapshot
...
func NewDatabase(diskdb corexdb.Database, config *Config) *Database {
...
// trie root), all internal trie nodes are referenced tocorexer by database itself.
//
// It's only supported by hash-based database and will return an error for others.
