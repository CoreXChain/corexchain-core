...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage CoreXChain presale wallets",
		ArgsUsage: "",
		Description: `
    corex wallet import /path/to/my/presale.wallet

will prompt for your password and imports your corex presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import CoreXChain presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	corex wallet [options] /path/to/my/presale.wallet
...
between corexchain nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    corex account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    corex account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another corexchain instance,
