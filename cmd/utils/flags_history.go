...
var (
	...
	LegacyWhitelistFlag = &cli.StringFlag{
		Name:     "whitelist",
		Usage:    "Comma separated block number-to-hash mappings to enforce (<number>=<hash>) (deprecated in favor of --corex.requiredblocks)",
		Category: flags.DeprecatedCategory,
	}
	...
	TxLookupLimitFlag = &cli.Uint64Flag{
		Name:     "txlookuplimit",
		Usage:    "Number of recent blocks to maintain value-flow index for (default = about one year, 0 = entire chain) (deprecated, use history.valueflows instead)",
