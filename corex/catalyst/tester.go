...
// FullSyncTester is an auxiliary service that allows CoreX to perform full sync
...
func RegisterFullSyncTester(stack *node.Node, backend *corex.CoreXChain, target common.Hash) (*FullSyncTester, error) {
	cl := &FullSyncTester{
		stack:   stack,
		backend: backend,
		target:  target,
