...
// ProtocolName is the official short name of the `corex` protocol used during
// devp2p capability negotiation.
const ProtocolName = "corex"

// ProtocolVersions are the supported versions of the `corex` protocol (first
// is primary).
...
// Packet represents a p2p message in the `corex` protocol.
...
func (request *NewBlockPacket) sanityCheck() error {
	...
	//TD at corenet block #7753254 is 76 bits. If it becomes 100 million times
...
// NewPooledTransactionHashesPacket represents a transaction announcement packet on corex/68 and newer.
