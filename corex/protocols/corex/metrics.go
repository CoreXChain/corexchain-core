...
func init() {
	meters = bidirectionalMeters{
		ingress: newHandshakeMeters("corex/protocols/corex/ingress/handshake/"),
		egress:  newHandshakeMeters("corex/protocols/corex/egress/handshake/"),
	}
}
