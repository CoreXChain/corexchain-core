...
type pathTrie struct {
	...
	db               corexdb.KeyValueReader
	batch            corexdb.Batch
}

// newPathTrie initializes the path trie.
func newPathTrie(owner common.Hash, skipLeftBoundary bool, db corexdb.KeyValueReader, batch corexdb.Batch) *pathTrie {
	tr := &pathTrie{
		owner:            owner,
...
func newHashTrie(batch corexdb.Batch) *hashTrie {
