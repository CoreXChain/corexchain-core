...
func (api *DownloaderAPI) eventLoop() {
	var (
		...
		getProgress = func() corexchain.SyncProgress {
			prog := api.d.Progress()
...
// Syncing provides information when this nodes starts synchronising with the CoreXChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  corexchain.SyncProgress `json:"status"`
}
