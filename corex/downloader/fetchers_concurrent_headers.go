...
func (q *headerQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *corex.Response) (*corex.Request, error) {
...
func (q *headerQueue) deliver(peer *peerConnection, packet *corex.Response) (int, error) {
	headers := *packet.Res.(*corex.BlockHeadersRequest)
