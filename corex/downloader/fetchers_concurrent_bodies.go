...
func (q *bodyQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *corex.Response) (*corex.Request, error) {
...
func (q *bodyQueue) deliver(peer *peerConnection, packet *corex.Response) (int, error) {
	txs, uncles, withdrawals := packet.Res.(*corex.BlockBodiesResponse).Unpack()
