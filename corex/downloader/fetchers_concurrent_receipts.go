...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *corex.Response) (*corex.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *corex.Response) (int, error) {
	receipts := *packet.Res.(*corex.ReceiptsResponse)
