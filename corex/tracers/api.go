...
// NewAPI creates a new API definition for the tracing methods of the CoreXChain service.
...
func (api *API) chainContext(ctx context.Context) core.ChainContext {
	return corexapi.NewChainContext(ctx, api.backend)
}
...
type TraceCallConfig struct {
	TraceConfig
	StateOverrides *corexapi.StateOverride
	BlockOverrides *corexapi.BlockOverrides
...
func (api *API) TraceTransaction(ctx context.Context, hash common.Hash, config *TraceConfig) (interface{}, error) {
	...
	if err != nil {
		return nil, corexapi.NewTxIndexingError()
	}
...
// TraceCall lets you trace a given corex_call. It collects the structured logs
...
func (api *API) TraceCall(ctx context.Context, args corexapi.TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceCallConfig) (interface{}, error) {
