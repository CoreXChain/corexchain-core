...
// the `coin_type` 60' (or 0x8000003C) to CoreXChain.
//
// The root path for CoreXChain is m/44'/60'/0'/0 according to the specification
// from https://corex.internal/EIPs/issues/84, albeit it's not set in stone
