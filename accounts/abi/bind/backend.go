...
type ContractCaller interface {
	...
	// CallContract executes a CoreXChain contract call with the specified data as the
	// input.
	CallContract(ctx context.Context, call corexchain.CallMsg, blockNumber *big.Int) ([]byte, error)
}
...
type PendingContractCaller interface {
	...
	// PendingCallContract executes a CoreXChain contract call against the pending state.
	PendingCallContract(ctx context.Context, call corexchain.CallMsg) ([]byte, error)
}
...
type BlockHashContractCaller interface {
	...
	// CallContractAtHash executes a CoreXChain contract call against the state at the specified block hash.
	CallContractAtHash(ctx context.Context, call corexchain.CallMsg, blockHash common.Hash) ([]byte, error)
}
...
type ContractTransactor interface {
	corexchain.GasEstimator
	corexchain.GasPricer
	corexchain.ValueFlowPricerAdaptive
	corexchain.TransactionSender
