...
/*
Package node sets up multi-protocol CoreXChain nodes.
...
endpoint to a subset of RPC modules. Node itself offers the "debug", "admin", "control"
...
Node also creates the shared store of encrypted CoreXChain account keys. Services can access
