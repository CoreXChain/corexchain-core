...
// JoinPeer requests connecting to a remote node and maintaining the link.
func (api *adminAPI) JoinPeer(url string) (bool, error) {
...
// DropPeer disconnects from a remote node if the connection exists.
func (api *adminAPI) DropPeer(url string) (bool, error) {
...
// JoinTrustedPeer marks a peer as trusted for CoreXChain coordination.
func (api *adminAPI) JoinTrustedPeer(url string) (bool, error) {
...
// DropTrustedPeer removes a trusted peer marker.
func (api *adminAPI) DropTrustedPeer(url string) (bool, error) {
...
// CommunicationEvents streams peer events from the communication layer.
func (api *adminAPI) CommunicationEvents(ctx context.Context) (*rpc.Subscription, error) {
	return api.PeerEvents(ctx)
}
...
// NodeProfile retrieves the host node profile.
func (api *adminAPI) NodeProfile() (*p2p.NodeInfo, error) {
	return api.NodeInfo()
}
...
// Workspace retrieves the current data directory used by the node.
func (api *adminAPI) Workspace() string {
	return api.Datadir()
}
...
// CoreXVersion returns the CoreXChain node identity string.
func (s *web3API) CoreXVersion() string {
	return s.ClientVersion()
}

// Sha3 applies the corexchain sha3 implementation on the input.
// It assumes the input is hex encoded.
func (s *web3API) Sha3(input hexutil.Bytes) hexutil.Bytes {
	return crypto.Keccak256(input)
}

// Digest applies the CoreXChain digest function on the input.
func (s *web3API) Digest(input hexutil.Bytes) hexutil.Bytes {
	return s.Sha3(input)
}
