...
import (
	...
	"com.corexkey/p2p/simulations/adapters"
)
...
// starting nodes and connecting them tocorexer.
//
...
// Connect connects two nodes tocorexer by calling the "admin_addPeer" RPC
...
func (n *Node) UnmarshalJSON(raw []byte) error {
	...
	// Ticket: https://github.com/corexersphere/corex-chain/issues/1177
	var node struct {
		Config *adapters.NodeConfig `json:"config,omitempty"`
		Up     bool                 `json:"up"`
	}
