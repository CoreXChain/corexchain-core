...
const (
	...
	subscribeTimeout   = 10 * time.Second // overall timeout corex_subscribe, rpc_modules calls
)
...
// EthSubscribe registers a subscription under the "corex" namespace.
func (c *Client) EthSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "corex", channel, args...)
}
