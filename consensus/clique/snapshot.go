...
func loadSnapshot(config *params.CliqueConfig, sigcache *sigLRU, db corexdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db corexdb.Database) error {
