...
// ecrecover extracts the CoreXChain account address from a signed header.
func ecrecover(header *types.Header, sigcache *sigLRU) (common.Address, error) {
	...
	// Recover the public key and the CoreXChain address
...
// CoreXChain testnet following the LegacyNet attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     corexdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // CoreXChain address of the signing key
...
func New(config *params.CliqueConfig, db corexdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the CoreXChain address recovered
